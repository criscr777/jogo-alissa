...
const story = {
    inicio: {
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Santiago, sente essa frequência no ar! Há uma câmara secreta ancestral ali embaixo.'", target: "fenda_alissa_1", nextTurn: "santiago" },
            { text: "Alissa: 'Preciso descer imediatamente para investigar a origem desse chamado.'", target: "fenda_alissa_2", nextTurn: "santiago" }
        ]
    },
    fenda_alissa_1: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Vou checar a estabilidade estrutural da rocha antes de qualquer passo falso.'", target: "santiago_checa_rocha", nextTurn: "alissa" },
            { text: "Santiago: 'Pega a minha lanterna tática de alta potência, você vai precisar ver no escuro.'", target: "santiago_da_lanterna", nextTurn: "alissa" }
        ]
    },
    fenda_alissa_2: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Segura na minha mão, vamos descer juntos com cuidado técnico.'", target: "santiago_descem_juntos", nextTurn: "alissa" },
            { text: "Santiago: 'Vou amarrar uma corda de segurança na rocha firme lá em cima.'", target: "santiago_usa_corda", nextTurn: "alissa" }
        ]
    },
    santiago_checa_rocha: {
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'As runas indicam que devemos seguir pelo corredor da esquerda, onde o ar é mais leve.'", target: "tunel_esquerda", nextTurn: "santiago" },
    ...
    santiago_da_lanterna: {
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Isso confirma lendas antigas sobre guardiões das marés!'", target: "tunel_esquerda", nextTurn: "santiago" },
            { text: "Alissa: 'Vamos analisar o solo com cautela para ver se há risco de desabamento.'", target: "sala_central", nextTurn: "santiago" }
        ]
    },
    santiago_descem_juntos: {
        ...
        choices: [
            ...
            { text: "Alissa: 'Vamos avançar com cautela, sinto uma presença incomum logo adiante.'", target: "tunel_esquerda", nextTurn: "santiago" }
        ]
    },
    santiago_usa_corda: {
        speaker: "Alissa",
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Se tocarmos nos cristais na ordem certa, podemos ativar a frequência deles.'", target: "sala_central", nextTurn: "santiago" },
            { text: "Alissa: 'Vamos mapear o perímetro primeiro para evitar armadilhas mecânicas.'", target: "tunel_esquerda", nextTurn: "santiago" }
        ]
    },
    tunel_esquerda: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Deixa que eu resolvo isso usando lógica numérica e o alinhamento das luas.'", target: "santiago_resolve_math", nextTurn: "alissa" },
            { text: "Santiago: 'Alissa, sua intuição diz qual símbolo devemos girar primeiro?'", target: "alissa_guia_puzzle", nextTurn: "alissa" }
        ]
    },
    sala_central: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Vou hackear o painel elétrico oxidado usando ferramentas improvisadas da minha mochila.'", target: "santiago_hackeia_painel", nextTurn: "alissa" },
            { text: "Santiago: 'Alissa, canaliza sua energia naqueles orbes para energizar a ponte!'", target: "alissa_energiza_orbes", nextTurn: "alissa" }
        ]
    },
    santiago_resolve_math: {
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Viu só? Ciência e mistério caminham lado a lado.'", target: "climax_final", nextTurn: "santiago" }
        ]
    },
    alissa_guia_puzzle: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Ok, eu me rendo. Sua intuição acertou em cheio dessa vez.'", target: "climax_final", nextTurn: "alissa" }
        ]
    },
    santiago_hackeia_painel: {
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Vamos atravessar correndo antes que o mecanismo feche de novo!'", target: "climax_final", nextTurn: "santiago" }
        ]
    },
    alissa_energiza_orbes: {
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: 'Isso foi surreal... Minha mente científica está bugada, mas foi lindo.'", target: "climax_final", nextTurn: "alissa" }
        ]
    },
    climax_final: {
        speaker: "Narrador",
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Nós desvendamos o impossível juntos, Santi. Cético e mística, a dupla perfeita.'", target: "final_romance", nextTurn: "santiago" }
        ]
    },
    final_romance: {
        speaker: "Santiago",
        ...
        turnOwner: "santiago",
        choices: [
            { text: "Santiago: Puxar ela para um beijo inesquecível.", target: "fim_reiniciar", nextTurn: "alissa" }
        ]
    },
    fim_reiniciar: {
        speaker: "Narrador",
        ...
        turnOwner: "alissa",
        choices: [
            { text: "Alissa: 'Vamos explorar tudo de novo!'", target: "inicio", nextTurn: "santiago" }
        ]
    }
};
...
function renderScene(sceneId, currentTurn) {
    ...
    // Garante que os personagens aparecem removendo a classe .hide
